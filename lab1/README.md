...
- [Changing the ColorsTable `<title>`](#changing-the-page-title)
...
- [Injecting Data from the Server into the ColorsTable](#injecting-data-from-the-server-into-the-page)
...
## Changing the ColorsTable `<title>`
...
## Injecting Data from the Server into the ColorsTable
